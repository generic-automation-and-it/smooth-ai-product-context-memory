...
| [BRD 003 — Understanding transfer and loading](../003-understanding-transfer/) | Extends this document (`BR-38` … `BR-45`): the Understanding kind, non-destructive load, opt-in import and current-session export. Owns [HLD 007](../../hlds/007-understanding-transfer/) |
