...
| Date | Change | Ref |
|:-----|:-------|:----|
| 2026-09-13 | Docker Desktop compose-project group for test containers is `Mímisbrunnr` (was `project`). Container names unchanged. | — |
