...
| Date | Change | Ref |
|:-----|:-------|:----|
| 2026-09-12 | Test Aspire MinIO image pinned to `docker.io/minio/minio:RELEASE.2025-10-15T17-29-55Z` (same tag as the dev AppHost). CI wait now probes TCP `:9002` before `/minio/health/live` and dumps container logs on timeout. | PR #17 |
