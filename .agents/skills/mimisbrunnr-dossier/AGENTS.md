...
| 2026-09-23 | Implemented the judgement skeleton (`scripts/dossier_composer.py`), the invocation contract (`SKILL.md`), and the committed L0 harness (`tests/run_tests.py`, 26 tests, NFR-04/05/06/07). | HLD-005; BRD-002 |
