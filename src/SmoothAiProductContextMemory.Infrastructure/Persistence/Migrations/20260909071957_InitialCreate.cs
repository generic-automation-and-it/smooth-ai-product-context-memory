...
namespace SmoothAiProductContextMemory.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Seed rows above supply explicit ids. Both columns are GENERATED BY DEFAULT AS IDENTITY,
            // so an explicit insert does NOT advance the backing sequence — it would still hand out 1
            // on the first generated insert, colliding with the seeded primary keys. Restart each
            // sequence past its seeded range.
            migrationBuilder.Sql("ALTER TABLE initiative ALTER COLUMN id RESTART WITH 2;");
            migrationBuilder.Sql("ALTER TABLE label ALTER COLUMN id RESTART WITH 12;");
