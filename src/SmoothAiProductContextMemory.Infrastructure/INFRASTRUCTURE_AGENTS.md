...
| Date | Change | Ref |
|:-----|:-------|:----|
| 2026-09-13 | Pooled `NpgsqlDataSource` with AGE physical-connection initialiser (`NoResetOnClose`). Graph objects created by SQL migration, not the EF model. | HLD-003 WT-01 |
